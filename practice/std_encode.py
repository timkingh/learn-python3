...
with open('std_yuv_list.txt',encoding='ascii',errors='ignore') as f:
...
while idx < len(cont) :
    ...
    cmd0 = "./std_weightp0.sh " + oneline[0].strip() + " " + oneline[1] + " " + oneline[2]
    cmd2 = "./std_weightp2.sh " + oneline[0].strip() + " " + oneline[1] + " " + oneline[2]
    print(cmd0)
    os.system(cmd0)
    os.system(cmd2)
    idx = idx + 1
